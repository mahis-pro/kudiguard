...
import { handleError, AuthError, ForbiddenError, InputValidationError } from '../_shared/errors.ts';
import { API_VERSION, CORS_HEADERS } from '../_shared/constants.ts';
import { CalculateScoreInputSchema } from '../_shared/schemas.ts';
